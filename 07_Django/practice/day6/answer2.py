...
>> b = Newspaper.objects.filter(journalist='Laney Mccullough')
>> print(len(b))
"""
...
>> last_data = Newspaper.objects.latest('pk')
>> print(f'title : {last_data.title}')
>> print(f'content : {last_data.content}')
>> print(f'journalist : {last_data.journalist}')
"""
